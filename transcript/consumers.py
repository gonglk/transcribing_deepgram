...
class TranscriptConsumer(AsyncWebsocketConsumer):
   ...
   async def get_transcript(self, data: Dict) -> None:
       if 'channel' in data:
           ...
           # key1: transcript_wiki
           # key2: transcript_chat
   ...
   async def connect_to_deepgram(self):
       try:
           self.socket = await self.dg_client.transcription.live({'punctuate': True, 'interim_results': False, 'endpointing':True, 'diarize':True})
